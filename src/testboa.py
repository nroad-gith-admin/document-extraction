...
wellsfargofolder = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/BS_NT/BS_BOA"
...
for file in files:
    print(file)
    excelRow = excelRow+1
    data = (extractobj.extractBankStatement(file, "bank of america",[1,2,2,]))
    print(data)
...
newfilename = "ExtractedDataBOA_Results.xls"
