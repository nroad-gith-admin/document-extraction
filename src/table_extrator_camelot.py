...
if __name__=="__main__":
    filepath = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/BS_NT/BS_USTest/0064O00000jteKqQAI-00P4O00001JkXBcUAN-__last_60_days_of_bank_stateme.pdf"
    ...
    page = 1
    tables = tableCamelotObj.extract_table(filepath, str(page),edge_tol=425)
