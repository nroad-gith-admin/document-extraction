...
wellsfargofolder = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/BS_NT/BS_WF"
...
for file in files:
    print(file)
    excelRow = excelRow+1
    data = (extractobj.extractBankStatement(file,2,3,4,"wells fargo"))
    print(data)
    ...
    sheet.write(excelRow, 13, data["SummaryInfo"])
    # break

newfilename = "ExtractedDataWellsFargo_Results2.xls"
