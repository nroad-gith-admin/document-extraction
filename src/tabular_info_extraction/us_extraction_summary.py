...
if __name__ == "__main__":
    data = {'payroll': {'Federal Benefit Deposit From SSA  TREAS 310 $ 0': ['Federal Benefit Deposit', 1473.1], 'Federal Benefit Deposit From SSA  TREAS 310 2': ['Federal Benefit Deposit', 1473.1]}, 'credit card': {'Electronic Withdrawal To CARDMEMBER SERV $ 13': ['CARDMEMBER SERV', -62.64], '5 Electronic Withdrawal To CARDMEMBER SERV 20': ['CARDMEMBER SERV', -4.95], 'Electronic Withdrawal To CARDMEMBER SERV 24': ['CARDMEMBER SERV', -105.21]}, 'loan': {}}
