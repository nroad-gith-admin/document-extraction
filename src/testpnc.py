...
wellsfargofolder = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/BS_NT/BS_PNC"
...
for file in files:
    print(file)
    excelRow = excelRow+1
    data = (extractobj.extractBankStatement(file, "pnc bank",[2,1,1,]))
    print(data)
...
newfilename = "ExtractedDataPNC_Results.xls"
