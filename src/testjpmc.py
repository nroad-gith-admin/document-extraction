...
wellsfargofolder = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/BS_NT/BS_JPMC"
...
for file in files:
    if ".pdf" in file:
        print(file)
        excelRow = excelRow+1
        data = (extractobj.extractBankStatement(file,1,2,2, "jpmorgan chase bank"))
        print(data)
...
newfilename = "ExtractedDataJPMC_Results.xls"
