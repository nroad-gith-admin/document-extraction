...
if __name__ == "__main__":
    filepath = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/trainingdata"
    ...
    for file in files:
        try:
            ...
            data = obj.read_page([1,2],)
            print( obj.is_electronicsPdf(),file,)
        except:
            pass

    # file = r"/Users/prasingh/Prashant/Prashant/CareerBuilder/Extraction/data/Batch1/0060B00000iAQtDQAW-00P4O00001KBNeJUAX-Donald Wilczynski blurry W2, P.pdf"
    # obj = ExtractElectronics(file)
    # numPage = obj.num_page()
    # metadata = obj.get_metadata()
    # print(obj.is_electronicsPdf())
